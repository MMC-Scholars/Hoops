...
public class Hoop : ABaseEntity
{
    ...
    public override void BaseStart()
    {
        ...
        startPos.Set(this.transform.position.x, 0, this.transform.position.z);
    ...
    public override void BaseUpdate()
    {
        ...
        switch (currentPattern)
        {
            ...
            case 3:
                ...
                this.transform.position = new Vector3(this.transform.position.x, startHeight + (Mathf.Sin(theta * Mathf.Deg2Rad) * vertMoveScale), this.transform.position.z);
                goto case 2;
            case 2:
            case 1:
